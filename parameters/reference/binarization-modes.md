...
`BinarizationModes` is a parameter to control the image binarization process. It consisits of one or more modes, each mode is a way to implement the binarization.
