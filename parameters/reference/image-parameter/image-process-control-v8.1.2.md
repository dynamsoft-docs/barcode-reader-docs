...
keywords: ImageParameter, image process control parameters, parameter reference, parameter
...
# ImageParameter Object | Image Process Control Parameters
 ...
 | [`ImageParameter.DeblurLevel`](other-image-process-control-parameters.md#deblurlevel) | Sets the degree of blurriness of the barcode. |
 ...
 | [`ImageParameter.Pages`](other-image-process-control-parameters.md#pages) | Sets the specific pages or the range of pages of a file (.tiff or .pdf) for barcode searching. |
 | [`ImageParameter.PDFRasterDPI`](other-image-process-control-parameters.md#pdfrasterdpi) | Sets the output image resolution. |
 | [`ImageParameter.PDFReadingMode`](other-image-process-control-parameters.md#pdfreadingmode) | Sets the way to detect barcodes from a PDF file when using the DecodeFile method. |
 ...
 | [`ImageParameter.ScaleDownThreshold`](other-image-process-control-parameters.md#scaledownthreshold) | Sets the threshold for the image shrinking. |
