...
`ResultCoordinateType` can be set dynamicaly during runtime as a member of `PublicRuntimeSettings` struct, it is one of the [`ResultCoordinateType`]({{ site.enumerations }}parameter-mode-enums.html#resultcoordinatetype) Enumeration items.
