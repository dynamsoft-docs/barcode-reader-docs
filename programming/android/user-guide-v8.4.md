...
description: This is the user guide - v8.4 of Dynamsoft Barcode Reader for Android SDK.
...
- [`DecodeFile`](api-reference/BarcodeReader/decode.md#decodefile)
- [`DecodeBase64String`](api-reference/BarcodeReader/decode.md#decodebase64string)
- [`DecodeBitmap`](api-reference/BarcodeReader/decode.md#decodebitmap)
- [`DecodeBuffer`](api-reference/BarcodeReader/decode.md#decodebuffer)
- [`DecodeFileInMemory`](api-reference/BarcodeReader/decode.md#decodefileinmemory)
...
dealling with high-resolution images. You can speed up the recognition process by restricting the scanning region.
