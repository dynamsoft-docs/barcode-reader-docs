...
## Structs
 ...
 | [`DM_DLSConnectionParameters`]({{ site.structs }}DMLTSConnectionParameters.html?src=cpp) | Defines a struct to configure the parameters to connect to license tracking server. |
