...
title: Dynamsoft Barcode Reader for .NET SDK - Release Notes v7.6 and below
description: This is the release notes page of Dynamsoft Barcode Reader for .NET SDK v7.6 and below.
