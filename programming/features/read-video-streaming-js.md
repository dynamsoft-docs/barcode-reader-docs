...
description: This page describes how to read barcodes from a video stream in Dynamsoft Barcode Reader JavaScript edition using the BarcodeScanner class, with a quick-start code example.
