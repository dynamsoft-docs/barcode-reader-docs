...
- Operating Systems:
    - Windows x64
    - Linux<sup>1</sup> (x64, ARM32, ARM64)
...
<sup>1</sup> DBR Python is not compatible with AWS Lambda
<sup>2</sup> DBR Python is not compatible with the M1 (ARM64) Mac devices.
